...
void Pelicula::actualizar(std::string _titulo, std::string _genero, int _duracion, std::string _clasificacion, std::string _fechaFin, std::string _codigo, std::string _idioma, std::string _fechaEstreno) {
    this->titulo = _titulo;
    this->genero = _genero;
    this->duracion = _duracion;
    this->clasificacion = _clasificacion;
